...
class IALocalStorage {
  ...
  /**
   * Set/get song blocked
   */
  static setSongBlocked = async (songurl) => {
  	await IAStorageManager.setItem('songurl', songurl);
  }
  /**
   * Set/get song blocked
   */
  static getSongBlocked = async () => {
  	await IAStorageManager.getItem('songurl');
  }
   ...
   * Set/get USER INFO Apple
   */
  static setMusic = async (userInfo) => {
  	await IAStorageManager.setItem('MUSIC', userInfo);
  }

  static getMusic = async () => {
  	return await IAStorageManager.getItem('MUSIC');
  }
  /**
   * Set/get screen
   */
