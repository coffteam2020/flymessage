	...
	return (
		<Animatable.View animation="flipInX" style={[styles.container, style]}>
			...
			<View style={styles.containerInput}>
				<PhoneInput initialCountry={`${country?.toLowerCase()}`} cancelText={cancelText} confirmText={confirmText} autoFormat backgroundColor={backgroundColor} borderColor={borderColor} onChangeText={onChangeText} allowZeroAfterCountryCode={false}/>
			</View>
		</Animatable.View>
	);
};
